...
def get_file_path(filename):
    ...
    if IS_RENDER:
        ...
        paths = {
            "Warranty Debit.xlsx": r"D:Power BI NewWarranty DebitWarranty Debit.xlsx",
            "Pending Warranty Claim Details.xlsx": r"D:Power BI NewWarranty DebitPending Warranty Claim Details.xlsx",
            "Transit_Claims_Merged.xlsx": r"D:Power BI NewWarranty DebitTransit_Claims_Merged.xlsx",
            "Pr_Approval_Claims_Merged.xlsx": r"D:Power BI Newwarranty dashboard renderPr_Approval_Claims_Merged.xlsx",
            "UserID.xlsx": r"D:Power BI NewWarranty DebitUserID.xlsx",
            "Image": r"D:Power BI NewWarranty DebitImage"
        }
...
def get_mahindra_images():
    ...
    image_folder = get_file_path('Image')
    images = []
    branding_images = []
    vehicle_images = []
...
def update_user_password_in_excel(user_id: str, new_password: str):
    ...
    try:
        user_file = get_file_path('UserID.xlsx')
...
if __name__ == "__main__":
    ...
    port = PORT  # Use Render PORT or default 8001
